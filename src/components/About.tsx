        ...
        <div className="mt-32 hidden space-y-24 pt-64 md:block">
          ...
          <div className="flex items-end justify-end">
            <img
              ...
              alt=""
              className="mt-6 h-[28rem] w-full object-cover px-6 pl-12"
            />
          </div>
        </div>
        <div className="static top-0 flex max-h-fit flex-col items-center justify-center gap-4 text-center md:sticky 2xl:gap-12">
          <div className="bottom-0 h-20 w-px bg-dark/30 md:bg-dark/0 xl:h-32 2xl:h-40"></div>
          <h3 className="text-4xl capitalize leading-snug sm:text-2xl md:mt-12 md:text-4xl lg:text-6xl lg:leading-tight xl:text-8xl 2xl:text-8xl 2xl:leading-tight">
            Aasra Hospitality
          </h3>
          <p className="text-justify text-sm text-dark/60 md:mb-12 md:text-center 2xl:text-base">
